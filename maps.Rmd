...
We'll the `state.x77` dataset for this example:
...
Package such as `statebins` create choropleth style maps with equal size regions that roughly represent the location of the region, but not the size or shape.
