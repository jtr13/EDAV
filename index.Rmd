...
What makes edav.info the best resource for learning R?
We give the reasons **why**! Many resources walk you through the code and visualization but skimp on the explanation. We want to tell you **why** a bar graph is better than a pie chart for a given data set in addition to the **how**. Ultimately, you will need to decide which visualization best expresses your findings we want to inform that decision.
