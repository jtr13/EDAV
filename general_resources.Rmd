...
- [New York Open Statistical Programming Meetup](https://www.meetup.com/nyhackr/): Meetups hosted by R afficionados on a variety of topics in statistical programming, but with a focus on the R language. Past speakers have included J.J. Allaire (founder of RStudio) and Hadley Wickham (core tidyverse developer). The other attendees are generally eager to welcome newcomers and all of their talks are available on the Lander Analytics Youtube channel.
