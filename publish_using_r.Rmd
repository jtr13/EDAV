...
This section discusses how we built this book and includes references for building sites and books of your own using R.
...
*Note: we are no longer using Travis.*
