...
- [Getting Started with GitHub Pages](https://guides.github.com/features/pages/){target="_blank"}: Short article from GitHub Guides on creating/hosting a website using GitHub Pages.
