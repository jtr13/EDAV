...
- [Color Oracle](https://colororacle.org/){target="_blank"}: Not sure how effective your project will be to a colorblind user? The Color Oracle tool can help. You can click to see how your screen would look to someone with various color vision deficiencies.
...
[An alternative to pink & blue: Colors for gender data](https://blog.datawrapper.de/gendercolor/){target="_blank"} -- excellent survey of the color pallettes used for gender by major news organizations, as well as suggestions for handling this tricky topic
