...
### Undoing stuff
 ...
 - Undo changes in one file since the last (or any) commit: `git checkout -- [filename]` [SO link](https://stackoverflow.com/questions/692246/undo-working-copy-modifications-of-one-file-in-git){target="_blank"}
