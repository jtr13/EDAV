...
### Undoing stuff
 ...
 - Undo deleted branch: Look for the SHA (hash) returned when you deleted the branch. Then `git checkout -b <branch-name> <SHA>` <br> See also: [Git undo local branch delete](https://stackoverflow.com/a/39038276/5314416){target="_blank"}
