...
* Use git/GitHub for version control, collaboration, and sharing code.
...
Recommended reading: [Ten Simple Rules for Reproducible Computational Research](https://journals.plos.org/ploscompbiol/article?id=10.1371/journal.pcbi.1003285){target="_blank"}.
...
You have a choice of report formats, all of which are rendered from `.R` and/or `.Rmd` files: `pdf_document`, `html_document`, [bookdown book](https://bookdown.org/yihui/bookdown/){target="_blank"}, or [shiny app](https://shiny.rstudio.com/){target="_blank"}.
