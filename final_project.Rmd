...
Your report should be submitted as a bookdown book, which you can create from [this template](https://github.com/jtr13/EDAVproject){target="_blank"}. Be sure to follow the instructions provided in the repo [README](https://github.com/jtr13/EDAVproject/blob/main/README.md){target="_blank"}. 
