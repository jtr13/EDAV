...
You have a choice of report formats, all of which are rendered from `.R` and/or `.Rmd` files: `pdf_document`, `html_document`, [bookdown book](https://bookdown.org/yihui/bookdown/){target="_blank"}, or [shiny app](https://shiny.rstudio.com/){target="_blank"}. If you choose bookdown, you may begin with the [EDAV project template](https://github.com/jtr13/EDAVproject){target="_blank"} on GitHub. Instructions are provided in the repo [README](https://github.com/jtr13/EDAVproject/blob/master/README.md){target="_blank"}.
